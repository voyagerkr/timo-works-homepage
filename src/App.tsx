...
const copy: Record<Lang, SiteCopy> = {
  ko: {
    ...
    news: [
      ...
      ['TIMO partner network', '빈 시간 워커와 파트너를 빠르게 연결하는 입점 구조를 준비하고 있습니다.'],
    ],
  ...
  ja: {
    ...
    news: [
      ...
      ['TIMO partner network', '空き時間ワーカーとパートナーをつなぐ入店モデルを準備しています。'],
    ],
  ...
  zh: {
    ...
    news: [
      ...
      ['TIMO partner network', '我们正在准备连接空闲时间工作者与用人伙伴的入驻模式。'],
    ],
